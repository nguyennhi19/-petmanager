                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <c:forEach var="product" items="${listP}">
                                                        <tr>
                                                            <td style="text-align: right"><c:out value="${product.id}"/></td>
                                                            <td><c:out value="${product.name}"/></td>
                                                            <td><c:out value="${product.species}"/></td>
<%--                                                            <td><c:out value="${product.price}"/></td>--%>
                                                            <td style="text-align: right"><strong><fmt:formatNumber value="${product.price}" type="currency" currencySymbol="₫"></fmt:formatNumber> </strong></td>
                                                            <td style="text-align: right"><c:out value="${product.quantity}"/></td>
                                                            <td width="120px">
                                                                <a href="/products?action=edit&id=${product.id}" class="btn-sm btn-primary" title="Edit" size="30"><i class="fa fa-edit"></i></a>
                                                                <a href="/products?action=delete&id=${product.id}" class="btn-sm btn-danger " title="Delete" size="30"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
