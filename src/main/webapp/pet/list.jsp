    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="http://localhost:8080/" class="logo"><img src="assets\images/anhshop.jpg" alt="logo-img" ></a>
                <a href="http://localhost:8080/" class="logo-sm"><img src="assets\images/anhshop.jpg" alt="logo-img"></a>
            </div>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="m-b-30 m-t-0">List Pet</h4>
                                    <h4>
                                        <a href="/pets?action=create">Add New Pet</a>
                                    </h4>
                                    <div class="row">
