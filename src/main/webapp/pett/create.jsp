            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Create pet</h4>
                                ...
                                <form method="post">
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <th>Age:</th>
                                            <td>
                                                <input type="number" name="age" id="age" size="45" required/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Gender:</th>
                                            <td>
                                                <input type="radio" name="gender" id="2" value="0" />nữ
                                                <input type="radio" name="gender" id="1" value="1" />nam
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>DateOfBirth:</th>
                                            <td>
                                                <input type="date" name="dateOfBirth" id="dateOfBirth" size="45" required/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Price:</th>
                                        ...
                                        <tr>
                                            <th>Species:</th>
                                            <td>
                                                <input type="text" name="species" id="species" size="20" required/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Quantity:</th>
                                            <td>
                                                <input type="number" name="quantity" id="quantity" size="45" required/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Status:</th>
                                            <td>
                                                <input type="text" name="status" id="status" size="20" required/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center">
                                                <input type="submit" value="Save"/>
                                                <a href="http://localhost:8080/product">Back to customer list</a>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
